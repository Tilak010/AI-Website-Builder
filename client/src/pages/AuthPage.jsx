        ...
        <div className='w-full max-w-sm'>
          ...
          <div className='mb-10'>
           ...
           <p className='text-sm text-zinc-400'>
            {isLogin ? "Enter your credetials to access your website builder." : 
            ...
            <form className='space-y-6' onSubmit={handleSubmit}>
             {!isLogin && (
              <div>
                ...
                tracking-widest mb-2'>Full Name</label>
                ...
                transition-colors' placeholder='Tish Meow'/>  
              </div>
             )}
              <div>
                <label className='block text-[11px] font-semibold text-zinc-400 uppercase 
                ...
                required className='w-full pl-2 py-2 border-b border-zinc-200 focus:outline-none 
                focus:border-zinc-950 text-sm text-zinc-900 bg-transparent placeholder-zinc-300 
                transition-colors' placeholder='you@example.com'/>  
              </div>
               ...
               <div>
                ...
                <button type='Button' onClick={()=> setShowPassword(!showPassword)}
                  ...
                  hover:text-zinc-600 flex items-center justify-center cursor-pointer transition-colors'>
                    {showPassword ? <EyeOffIcon size={14}/>:<EyeOffIcon size={14}/>}
                </button>  
                </div> 
              </div>

              <button type='submit' disabled={loading} className='w-full py-2.5 bg-linear-to-br 
              from-red-600 to-amber-600 text-white font-semibold hover:scale-102 disabled:opacity-40
              flex items-center justify-center cursor-pointer mt-2 rounded-lg transition-all'>
