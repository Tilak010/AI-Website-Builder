...
function TreeItem({node, activeFile, onFileSelect, depth = 0  }){
  ...
  return (
    ...
    className={`w-full flex items-center gap-2 py-1.5 px-2 text-xs transition-colors rounded-md 
    cursor-pointer ${isActive ? " bg-zinc-100 text-zinc-950 font-medium" : 
