...
const PublishModal = ({ publishUrl, onClose }) => {
  ...
  return (
    ...
    z-50'>
       <div className='bg-white border border-zinc-200 shadow-lg rounded-xl max-w-md w-full p-6 
       mx-4 relative'>  
          ...
          <div className='space-y-4'>
             <div>
                ...
                <input type="text" readOnly value={publishUrl} className='
                w-full px-0 py-2 border-b border-zinc-200 text-sm text-zinc-900 bg-transparent
                outline-none'/>
             </div>
             <div className='flex gap-2 pt-2'>
               ...
               className='flex-1 py-2 border border-zinc-200 text-zinc-700 text-xs 
               font-medium hover:bg-zinc-50 cursor-pointer rounded-lg text-center'>
                 Open Site
               </button>
             </div>
          </div>
