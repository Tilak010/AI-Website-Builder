  ...
  return (
    <header className='h-12 shrink-0 flex items-center justify-between px-3 border-b border-zinc-200 bg-white'>
      ...
      <div className='flex items-center gap-2'>
         <button onClick={onBack} className='p-1.5 rounded-md text-zinc-400 hover:text-zinc-950 hover:bg-zinc-100
         cursor-pointer'>
      ...
      <div className='flex items-center gap-1.5'>
         ...
         hover:text-zinc-900 text-xs font-medium rounded-lg cursor-pointer bg-white ${showCode ? "bg-zinc-100 text-zinc-900" : ""}`}>
         {showCode ? (
            <>
        ...
        className='inline-flex itmes-center justify-center gap-1.5 py-1.5 px-3 border 
